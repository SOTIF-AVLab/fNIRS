...
#########################################Lead vehicle autonomous emergency braking in a short distance scenario#####################
     plt.figure(1)
     line1=plt.plot(Position_X,Low_Data_Mean[0,0:NUM_X],color="red",linewidth=1.5,  marker='o',markersize = 15)
     line2=plt.plot(Position_X,Hight_Data_Mean[0,0:NUM_X],color="blue",linewidth=1.5,marker='o',markersize = 15 )
...
#########################################Lead vehicle cut-in from left lane in a short distance scenario#####################
     plt.figure(2)
     line1=plt.plot(Position_X,Low_Data_Mean[1,0:NUM_X],color="red",linewidth=1.5,  marker='o',markersize = 15)
     line2=plt.plot(Position_X,Hight_Data_Mean[1,0:NUM_X],color="blue",linewidth=1.5,marker='o',markersize = 15 )
     plt.ylabel(r'$\Delta$COE(umol/L)')
     plt.xticks(Position_X, labels, rotation=45)
...
#########################################Lead vehicle cut-in from right lane in a short distance scenario#####################
     plt.figure(3)
     line1=plt.plot(Position_X,Low_Data_Mean[2,0:NUM_X],color="red",linewidth=1.5,  marker='o',markersize = 15)
     line2=plt.plot(Position_X,Hight_Data_Mean[2,0:NUM_X],color="blue",linewidth=1.5,marker='o',markersize = 15 )
     plt.ylabel(r'$\Delta$COE(umol/L)')
     plt.xticks(Position_X, labels, rotation=45)
...
#########################################Pedestrian crossing road from right scenario#####################
     plt.figure(4)
     line1=plt.plot(Position_X,Low_Data_Mean[3,0:NUM_X],color="red",linewidth=1.5,  marker='o',markersize = 15)
     line2=plt.plot(Position_X,Hight_Data_Mean[3,0:NUM_X],color="blue",linewidth=1.5,marker='o',markersize = 15 )
     plt.ylabel(r'$\Delta$COE(umol/L)')
     plt.xticks(Position_X, labels, rotation=45)
...
#########################################Lead vehicle autonomous emergency braking in a short distance scenario#####################
     plt.figure(1)
     line1=plt.plot(Position_X,Hight_Data_Mean[0,0:NUM_X],color="red",linewidth=1.5,  marker='o',markersize = 15)
     line2=plt.plot(Position_X,Hight_Data_Mean[1,0:NUM_X],color="blue",linewidth=1.5,marker='o',markersize = 15 )
     line3=plt.plot(Position_X,Hight_Data_Mean[2,0:NUM_X],color="k",linewidth=1.5,  marker='o',markersize = 15)
     line4=plt.plot(Position_X,Hight_Data_Mean[3,0:NUM_X],color="g",linewidth=1.5,marker='o',markersize = 15 )
...
def fun_plot_sex(Data_Sex_Male,Data_Sex_Female):
    ...
    for key, value in Data_Sex_Male.items():
        ...
        Name_Figure=Current_Postion+'/Result/Sex'+key+'.pdf'
        ...
        plt.ylabel(r'$\Delta$COE(umol/L)', fontsize=10,fontweight='bold')
        labels = 'LM','HM','LF','HF'
        # f = plt.boxplot([Mean_Data_Sex_Male[:,0],Mean_Data_Sex_Male[:,1],Mean_Data_Sex_FeMale[:,0],Mean_Data_Sex_FeMale[:,1]],labels = labels,whiskerprops={'linewidth': '2'},meanprops={'linewidth': '1.5'},flierprops={'linewidth': '1.5'},patch_artist=True,boxprops={'linewidth': '1.5','facecolor':'lightgreen'})
        # f = plt.boxplot([Mean_Data_Sex_Male[:,0],Mean_Data_Sex_Male[:,1],Mean_Data_Sex_FeMale[:,0],Mean_Data_Sex_FeMale[:,1]],labels = labels,whiskerprops={'linewidth': '2'},meanprops={'color':'k','linewidth': '2'},medianprops={'color':'k','linewidth': '1.5'},flierprops={'linewidth': '1.5','markersize':'12'},patch_artist=True,boxprops={'linewidth': '1.5'})
        f = plt.boxplot([Mean_Data_Sex_Male[:,0],Mean_Data_Sex_Male[:,1],Mean_Data_Sex_FeMale[:,0],Mean_Data_Sex_FeMale[:,1]],labels = labels,whiskerprops={'linewidth': '1.5'},meanprops={'color':'k','linewidth': '1.5'},medianprops={'color':'k','linewidth': '1.5'},flierprops={'linewidth': '1.5','markersize':'12'},patch_artist=True,boxprops={'linewidth': '1.5'},capprops={'linewidth': '1.5'})
        colors=['steelblue', 'peru', 'seagreen','brown']
...
def fun_plot_driver(Data_Driver_No,Data_Driver_Yes):
    ...
    for key, value in Data_Driver_No.items():
        Current_Postion=os.getcwd()
        Name_Figure=Current_Postion+'/Result/Driver'+key+'.pdf'
        if os.path.exists(Name_Figure):
           os.remove (Name_Figure)
        ...
        f = plt.boxplot([Mean_Data_Driver_No[:,0],Mean_Data_Driver_No[:,1],Mean_Data_Driver_Yes[:,0],Mean_Data_Driver_Yes[:,1]],labels = labels01,whiskerprops={'linewidth': '1.5'},meanprops={'color':'k','linewidth': '1.5'},medianprops={'color':'k','linewidth': '1.5'},flierprops={'linewidth': '1.5','markersize':'12'},patch_artist=True,boxprops={'linewidth': '1.5'},capprops={'linewidth': '1.5'})
        colors=['steelblue', 'peru', 'seagreen','brown']
        for box,c in zip(f['boxes'], colors):
            # 箱体边框颜色
            box.set(color=c, linewidth=1.5)
